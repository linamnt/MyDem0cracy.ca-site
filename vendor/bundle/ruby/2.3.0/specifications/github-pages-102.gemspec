# -*- encoding: utf-8 -*-
# stub: github-pages 102 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.3.0"])
      ...
      s.add_runtime_dependency(%q<jekyll-sitemap>.freeze, ["= 0.11.0"])
      s.add_runtime_dependency(%q<jekyll-feed>.freeze, ["= 0.7.2"])
      ...
      s.add_dependency(%q<jekyll>.freeze, ["= 3.3.0"])
      ...
      s.add_dependency(%q<jekyll-sitemap>.freeze, ["= 0.11.0"])
      s.add_dependency(%q<jekyll-feed>.freeze, ["= 0.7.2"])
